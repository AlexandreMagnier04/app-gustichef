...
<div class="mb-6 divide-y divide-navy/8 rounded-2xl border border-navy/8">
	...
	<div class="px-4 py-3.5">
		<label for="sec-current-pwd" class="mb-1 block text-xs font-medium text-navy/60">Mot de passe actuel</label>
		<input
			type="password"
			id="sec-current-pwd"
	...
	<div class="px-4 py-3.5">
		<label for="sec-new-pwd" class="mb-1 block text-xs font-medium text-navy/60">Nouveau mot de passe</label>
		<input
			type="password"
			id="sec-new-pwd"
