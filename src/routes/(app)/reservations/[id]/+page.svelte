...
<div class="-mx-5 -mt-3 pb-24">
	...
	<div class="flex items-center justify-between border-b border-navy/8 px-4 py-3">
		<div class="flex items-center gap-3">
			...
			>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-4 w-4 text-navy/60">
		...
		<span class="rounded-full px-3 py-1 text-[11px] font-semibold {r.statut === 'confirme' ? 'bg-green-500/15 text-green-600' : 'bg-rust/15 text-rust'}">
	...
	<div class="space-y-5 px-4 pt-5">
			...
			<a href="/chiefs/{r.id_chief}" class="flex items-center gap-3 py-2">
				<div class="h-14 w-14 shrink-0 overflow-hidden rounded-full bg-navy/10">
					...
					{:else}
						<div class="flex h-full w-full items-center justify-center">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-7 w-7 text-navy/30">
				...
				<div class="min-w-0 flex-1">
					<div class="flex items-center gap-1">
						...
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="h-4 w-4 shrink-0 text-teal">
					...
					{#if r.chief.localization}
						<div class="mt-0.5 flex items-center gap-1 text-[12px] text-navy/40">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="h-3 w-3 shrink-0 text-teal">
								<path fill-rule="evenodd" d="M8 1.5a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9ZM2 6a6 6 0 1 1 10.174 4.31c-.203.196-.43.37-.66.533l-3.67 2.938a.75.75 0 0 1-.936 0l-3.67-2.938a6.08 6.08 0 0 1-.66-.533A5.976 5.976 0 0 1 2 6Zm4.5.25a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Z" clip-rule="evenodd" />
							</svg>
		...
		<div class="space-y-0 divide-y divide-navy/8">
			...
			{#if r.event_time}
				<div class="flex items-center gap-3 py-3">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="h-4 w-4 shrink-0 text-teal">
						<path fill-rule="evenodd" d="M1 8a7 7 0 1 1 14 0A7 7 0 0 1 1 8Zm7-4.75a.75.75 0 0 0-.75.75v4.5c0 .264.138.51.366.647l3 1.75a.75.75 0 0 0 .768-1.286L8.75 8.085V4a.75.75 0 0 0-.75-.75Z" clip-rule="evenodd" />
					</svg>
		...
		<div>
			...
			<div class="mt-3 flex justify-between border-t border-navy/8 pt-3 text-sm font-bold text-navy">
