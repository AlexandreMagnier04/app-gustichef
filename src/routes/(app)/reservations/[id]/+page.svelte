...
<div class="-mx-5 -mt-3 pb-10">
	...
	<div class="flex items-center justify-between border-b border-navy/[0.07] px-4 py-3">
		<div class="flex items-center gap-3">
			<a href="/messages/{r.id_conversation}" class="flex h-8 w-8 items-center justify-center rounded-full text-navy/60">
		...
		<span class="rounded-full px-3 py-1 text-[11px] font-semibold {r.statut === 'confirme' ? 'bg-teal/15 text-teal' : 'bg-rust/15 text-rust'}">
	...
	<div class="px-4 pt-5 space-y-5">
		...
		<div class="space-y-2.5">
			<div class="flex items-center gap-2.5 text-sm text-navy/70">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="h-4 w-4 shrink-0 text-navy/40">
		...
		{#if r.menu_title}
			<div class="overflow-hidden rounded-2xl border border-navy/[0.07] bg-white">
				<div class="p-4">
					<p class="text-[11px] font-semibold uppercase tracking-wider text-rust">Menu proposé</p>
		...
		<div class="rounded-2xl border border-navy/[0.07] bg-white p-4">
			...
			<div class="mt-3 flex justify-between border-t border-navy/[0.07] pt-3 text-sm font-bold text-navy">
		...
		<div class="space-y-3">
			<div class="flex items-start gap-3">
				...
				<div>
					...
					<p class="text-sm text-navy/60">Acompte de 50 % débité ({acompte} €) pour l'achat des ingrédients</p>
				</div>
			</div>
			<div class="flex items-start gap-3">
				...
				<div>
					...
					<p class="text-sm text-navy/60">Solde de 50 % débité ({acompte} €) une fois la prestation confirmée</p>
				</div>
			</div>
		</div>
